...
namespace ImGalaxy.ES.CosmosDB
{
    public static class CosmosConverterExtensions
    {
        public static CosmosStream ToCosmosStream(this StreamDocument document, IEnumerable<EventDocument> eventDocs) =>
             new CosmosStream(document.Id, document.Type, document.Version, StreamReadStatus.Success, 
                ReadDirection.Forward,
                eventDocs.Select(e=> new CosmosEvent(e.StreamId, e.Id, e.Position, e.Type, e.Data, e.EventMetadata, DateTime.Now))
                    .ToArray());
        ...
        public static CosmosEvent ToCosmosEvent(this EventDocument document) =>
             new CosmosEvent(document.StreamId, document.Id, document.Position, document.Type,
